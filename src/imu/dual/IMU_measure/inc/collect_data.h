...
#define IMU_PORT "/dev/ttyACM0" // IMU串口路径 (保留兼容)
#define IMU_PORT_LEFT  "/dev/ttyACM0" // 左手IMU串口路径
#define IMU_PORT_RIGHT "/dev/ttyACM1" // 右手IMU串口路径
#define BUF_SIZE 65536          // 64KB 环形缓冲区
#define FLUSH_THRESHOLD 50      // 每累积50帧, 报告一次进度
#define CSV_PATH_MAX 256        // CSV文件路径最大长度
...
#define TARGET_FRAMES 3000-5    // 目标帧数
